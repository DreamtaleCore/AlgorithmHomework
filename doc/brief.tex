...
\begin{document}
  ...
  \subsection{Introduction}
    Dynamic programming is a method of computing the optimal result.
    
    The main question as following:
    \begin{itemize}
      \item The minimal path of a graph
      \item The plan of parts in a production 
      \item others
    \end{itemize}
